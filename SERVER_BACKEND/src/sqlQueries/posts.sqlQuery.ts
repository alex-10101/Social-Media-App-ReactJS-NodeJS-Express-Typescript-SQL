...
/**
 * Sql query that returns all the posts of the current user
...
/**
 * Sql query that returns the post with a particular id from the database.
...
/**
 * Sql query that inserts a new post in the database with the input provided by the user
...
/**
 * Sql query that deletes a particular post made by a particular user.
