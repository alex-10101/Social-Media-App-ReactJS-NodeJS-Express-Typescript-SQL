...
/**
 * SQL query that inserts a new user in the database
 * @param email
 * @param passoword
 * @param userName
 * @param realName
...
/**
 * SQL query that retreives the token info stored with a particular refresh token from the database
 * @param refreshToken
 * @returns
 */
...
/**
 * SQL query that retreives the user with the given id from the database
 * @param userId
 * @returns
 */
