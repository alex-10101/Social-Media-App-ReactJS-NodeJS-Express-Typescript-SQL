...
/**
 * SQL query that returns all ids of the users who liked a particular post
...
/**
 * SQL query that inserts the id of the user who likes a post, and the id of the post liked by the user
 * @param userId
 * @param postId
 */
...
/**
 * SQL query that deletes the like made by a particular user on a particular post
 * @param userId
 * @param postId
 */
